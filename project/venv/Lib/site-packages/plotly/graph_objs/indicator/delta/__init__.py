...
an instance of :class:`plotly.graph_objs.indicator.delta.Increasing`"""
        ...
        # ---------------------
        self._validators["color"] = v_increasing.ColorValidator()
        self._validators["symbol"] = v_increasing.SymbolValidator()
...
an instance of :class:`plotly.graph_objs.indicator.delta.Decreasing`"""
        ...
        # Initialize validators
        # ---------------------
        self._validators["color"] = v_decreasing.ColorValidator()
        self._validators["symbol"] = v_decreasing.SymbolValidator()
